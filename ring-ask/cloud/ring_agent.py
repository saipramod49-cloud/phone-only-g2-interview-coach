...
Return TWO useful views of the same answer using exactly these headers:
SPOKEN:
FLOW:
...
FLOW must be a compact visual memory map of the same answer in 3–5 lines. Use this format:
KEY STEP — short cue
-> NEXT STEP — short cue
...
def prompt(style):
    lengths = {'brief':'Keep SPOKEN to 35–55 words and FLOW to 3 nodes.',
               'natural':'Keep SPOKEN concise and conversational. Keep FLOW to 3–5 short nodes. Short follow-ups can be shorter.',
               'detailed':'Keep SPOKEN to 90–130 words and FLOW to 4–6 nodes when detail is requested.'}
