...
def handle(environ, start_response, credentials, conversation, model):
    ...
    if path == '/api/health' and method == 'GET':
        return reply('200 OK', {'configured': bool(credentials.get('api_key')), 'model':model, 'fast_answer_model':'gpt-5.6-sol', 'live_model':'gpt-live-1', 'live_transport':True, 'profile_loaded':ring_agent.bridge.EXPERIENCE.exists(), 'version':'0.9.0', 'answer_style':'concise-direct-v3', 'reasoning':'low', 'max_recording_seconds':300})
