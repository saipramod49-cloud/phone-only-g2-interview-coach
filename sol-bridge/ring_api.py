...
def handle(environ, start_response, credentials, conversation, model):
    ...
    if path == '/api/health' and method == 'GET':
        return reply('200 OK', {'configured': bool(credentials.get('api_key')), 'model':model, 'fast_answer_model':'gpt-5.6-sol', 'profile_loaded':ring_agent.bridge.EXPERIENCE.exists(), 'version':'0.7.5', 'answer_style':'concise-direct-v3', 'reasoning':'low', 'max_recording_seconds':300})
